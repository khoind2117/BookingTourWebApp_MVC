...
namespace BookingTourWebApp_MVC.Controllers
{
    public class TicketManagementController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,AppUserId,FlightId,BusinessTickets,EconomyTickets,TotalPrice,BookingTime")] Booking booking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,AppUserId,FlightId,BusinessTickets,EconomyTickets,TotalPrice,BookingTime")] Booking booking)
        {
            if (id != booking.Id)
            {
                return NotFound();
